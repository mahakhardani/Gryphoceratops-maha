  ...
  return (
    <div className="home page">
      ...
      <Section name="instructions" title="Instructions">
        <p>
          You have just joined the Maiia Pro team as a full-stack developper,
          your first mission is to implement several crucial features for the
          success of the company.{' '}
        </p>
        <p>Here are the features to implement:</p>
        <ul>
          <li>Availabilities' generation </li>
          <li>Appointments creation (form + api route)</li>
